...
from vllm.model_executor.layers.npu.activation import SiluAndMul
from vllm.model_executor.layers.npu.layernorm import RMSNorm
from vllm.model_executor.layers.linear import ReplicatedLinear, MergedColumnParallelLinear, QKVParallelLinear
from vllm.model_executor.layers.npu.linear import QKVLinear
    ...
    def load_weights(self, weights: Iterable[Tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            ...
            for param_name, weight_name, shard_id in stacked_params_mapping:
                ...
                #print(f"param_name {param_name} weight_name {weight_name} shard_id {shard_id}")
                #print(type(param))
